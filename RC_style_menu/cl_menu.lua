local PANEL = {}
	function PANEL:Init()
		...
		self:SetSize(width, ScrH()*0.3)
		self:SetPos(ScrW()*0.8, ScrH())
		self:SetPaintBackground(false)
		self:MakePopup()
		self:MoveTo(ScrW()*0.8, ScrH()*0.7, 0.25, 0, 0.15)
		...
		self.close.OnClick = function()
			self:MoveTo(ScrW()*0.8, ScrH(), 0.25, 0, 0.5)
